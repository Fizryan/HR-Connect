...
final goRouterProvider = Provider<GoRouter>((ref) {
  final authStateNotifier = ValueNotifier<AuthState>(ref.read(authNotifierProvider));
  ...
  return GoRouter(
    ...
    routes: [
      GoRoute(
        path: '/splash',
        name: 'splash',
        builder: (context, state) => const Scaffold(), // TODO: Splash Screen
      ),
      GoRoute(
        path: '/',
        name: 'home',
      ...
      GoRoute(
        path: '/login',
        name: 'login',
        builder: (context, state) => const Scaffold(), // Login Screen
      ),
    ],
