...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function(@JsonKey(name: 'accessToken')  String accessToken, @JsonKey(name: 'refreshToken')  String refreshToken, @JsonKey(name: 'expTime', fromJson: ApiDateUtils.parseToDateTime)  DateTime expTime)?  success,TResult Function( String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthSuccess() when success != null:
return success(_that.accessToken,_that.refreshToken,_that.expTime);case _AuthError() when error != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function(@JsonKey(name: 'accessToken')  String accessToken, @JsonKey(name: 'refreshToken')  String refreshToken, @JsonKey(name: 'expTime', fromJson: ApiDateUtils.parseToDateTime)  DateTime expTime)  success,required TResult Function( String message)  error,}) {final _that = this;
switch (_that) {
case _AuthSuccess():
return success(_that.accessToken,_that.refreshToken,_that.expTime);case _AuthError():
return error(_that.message);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function(@JsonKey(name: 'accessToken')  String accessToken, @JsonKey(name: 'refreshToken')  String refreshToken, @JsonKey(name: 'expTime', fromJson: ApiDateUtils.parseToDateTime)  DateTime expTime)?  success,TResult? Function( String message)?  error,}) {final _that = this;
switch (_that) {
case _AuthSuccess() when success != null:
return success(_that.accessToken,_that.refreshToken,_that.expTime);case _AuthError() when error != null:
return error(_that.message);case _:
...
class _AuthSuccess implements AuthModel {
  const _AuthSuccess({@JsonKey(name: 'accessToken') required this.accessToken, @JsonKey(name: 'refreshToken') required this.refreshToken, @JsonKey(name: 'expTime', fromJson: ApiDateUtils.parseToDateTime) required this.expTime, final  String? $type}): $type = $type ?? 'success';
...
@JsonKey(name: 'expTime', fromJson: ApiDateUtils.parseToDateTime) final  DateTime expTime;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AuthSuccess&&(identical(other.accessToken, accessToken) || other.accessToken == accessToken)&&(identical(other.refreshToken, refreshToken) || other.refreshToken == refreshToken)&&(identical(other.expTime, expTime) || other.expTime == expTime));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,accessToken,refreshToken,expTime);

@override
String toString() {
  return 'AuthModel.success(accessToken: $accessToken, refreshToken: $refreshToken, expTime: $expTime)';
}
...
@useResult
$Res call({
@JsonKey(name: 'accessToken') String accessToken,@JsonKey(name: 'refreshToken') String refreshToken,@JsonKey(name: 'expTime', fromJson: ApiDateUtils.parseToDateTime) DateTime expTime
});
...
/// Create a copy of AuthModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? accessToken = null,Object? refreshToken = null,Object? expTime = null,}) {
