...
@JsonKey(name: 'id') String get id;@JsonKey(name: 'requesterId') String get requesterId;@JsonKey(name: 'data') LeaveData get data;@JsonKey(name: 'status') RequestStatus get status;@JsonKey(name: 'approverId') String? get approverId;
...
@override
String toString() {
  return 'LeaveModel(id: $id, requesterId: $requesterId, data: $data, status: $status, approverId: $approverId)';
}
...
@useResult
$Res call({
@JsonKey(name: 'id') String id,@JsonKey(name: 'requesterId') String requesterId,@JsonKey(name: 'data') LeaveData data,@JsonKey(name: 'status') RequestStatus status,@JsonKey(name: 'approverId') String? approverId
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'id')  String id, @JsonKey(name: 'requesterId')  String requesterId, @JsonKey(name: 'data')  LeaveData data, @JsonKey(name: 'status')  RequestStatus status, @JsonKey(name: 'approverId')  String? approverId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LeaveModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'id')  String id, @JsonKey(name: 'requesterId')  String requesterId, @JsonKey(name: 'data')  LeaveData data, @JsonKey(name: 'status')  RequestStatus status, @JsonKey(name: 'approverId')  String? approverId)  $default,) {final _that = this;
switch (_that) {
case _LeaveModel():
return $default(_that.id,_that.requesterId,_that.data,_that.status,_that.approverId);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'id')  String id, @JsonKey(name: 'requesterId')  String requesterId, @JsonKey(name: 'data')  LeaveData data, @JsonKey(name: 'status')  RequestStatus status, @JsonKey(name: 'approverId')  String? approverId)?  $default,) {final _that = this;
switch (_that) {
case _LeaveModel() when $default != null:
return $default(_that.id,_that.requesterId,_that.data,_that.status,_that.approverId);case _:
  return null;
...
class _LeaveModel implements LeaveModel {
  const _LeaveModel({@JsonKey(name: 'id') required this.id, @JsonKey(name: 'requesterId') required this.requesterId, @JsonKey(name: 'data') required this.data, @JsonKey(name: 'status') required this.status, @JsonKey(name: 'approverId') this.approverId});
...
@override $LeaveDataCopyWith<$Res> get data;
