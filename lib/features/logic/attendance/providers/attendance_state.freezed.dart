...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( List<AttendanceModel> attendances)?  dataList,TResult Function( AttendanceModel attendance)?  data,TResult Function( String message)?  success,TResult Function( String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loading() when loading != null:
return loading();case _DataList() when dataList != null:
return dataList(_that.attendances);case _Data() when data != null:
return data(_that.attendance);case _Success() when success != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( List<AttendanceModel> attendances)  dataList,required TResult Function( AttendanceModel attendance)  data,required TResult Function( String message)  success,required TResult Function( String message)  error,}) {final _that = this;
switch (_that) {
case _Initial():
return initial();case _Loading():
return loading();case _DataList():
return dataList(_that.attendances);case _Data():
return data(_that.attendance);case _Success():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( List<AttendanceModel> attendances)?  dataList,TResult? Function( AttendanceModel attendance)?  data,TResult? Function( String message)?  success,TResult? Function( String message)?  error,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loading() when loading != null:
return loading();case _DataList() when dataList != null:
...
class _DataList implements AttendanceState {
  const _DataList(final  List<AttendanceModel> attendances): _attendances = attendances;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _DataList&&const DeepCollectionEquality().equals(other._attendances, _attendances));
}
...
@override
String toString() {
  return 'AttendanceState.dataList(attendances: $attendances)';
}
...
/// @nodoc
abstract mixin class _$DataListCopyWith<$Res> implements $AttendanceStateCopyWith<$Res> {
...
null == attendances ? _self._attendances : attendances // ignore: cast_nullable_to_non_nullable
...
class _Data implements AttendanceState {
  const _Data(this.attendance);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Data&&(identical(other.attendance, attendance) || other.attendance == attendance));
}
...
@override
String toString() {
  return 'AttendanceState.data(attendance: $attendance)';
}
...
/// @nodoc
abstract mixin class _$DataCopyWith<$Res> implements $AttendanceStateCopyWith<$Res> {
