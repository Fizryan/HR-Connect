  ...
  Future<void> _submitForm() async {
    ...
    try {
      ...
      if (widget.existingRequestId != null) {
        ...
        await ref.read(leaveNotifierProvider.notifier).createLeaveRequest(requestData);
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: const Text('Leave request created successfully'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text(
          isUpdate ? 'Edit Leave Request' : 'New Leave Request',
          style: TextStyle(
            fontSize: 18.sp,
