...
mixin _$AttendanceModel {
 ...
 String get uid; String get requestedById;@JsonKey(name: 'login_time') DateTime? get loginTme;@JsonKey(name: 'logout_time') DateTime? get logoutTime;
...
@useResult
$Res call({
 String uid, String requestedById,@JsonKey(name: 'login_time') DateTime? loginTme,@JsonKey(name: 'logout_time') DateTime? logoutTime
});
...
/// Create a copy of AttendanceModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? uid = null,Object? requestedById = null,Object? loginTme = freezed,Object? logoutTime = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String uid,  String requestedById, @JsonKey(name: 'login_time')  DateTime? loginTme, @JsonKey(name: 'logout_time')  DateTime? logoutTime)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AttendanceModel() when $default != null:
return $default(_that.uid,_that.requestedById,_that.loginTme,_that.logoutTime);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String uid,  String requestedById, @JsonKey(name: 'login_time')  DateTime? loginTme, @JsonKey(name: 'logout_time')  DateTime? logoutTime)  $default,) {final _that = this;
switch (_that) {
case _AttendanceModel():
return $default(_that.uid,_that.requestedById,_that.loginTme,_that.logoutTime);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String uid,  String requestedById, @JsonKey(name: 'login_time')  DateTime? loginTme, @JsonKey(name: 'logout_time')  DateTime? logoutTime)?  $default,) {final _that = this;
switch (_that) {
case _AttendanceModel() when $default != null:
return $default(_that.uid,_that.requestedById,_that.loginTme,_that.logoutTime);case _:
  return null;
...
class _AttendanceModel implements AttendanceModel {
  const _AttendanceModel({required this.uid, required this.requestedById, @JsonKey(name: 'login_time') this.loginTme, @JsonKey(name: 'logout_time') this.logoutTime});
...
@override@JsonKey(name: 'login_time') final  DateTime? loginTme;
@override@JsonKey(name: 'logout_time') final  DateTime? logoutTime;
...
/// Create a copy of AttendanceModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? uid = null,Object? requestedById = null,Object? loginTme = freezed,Object? logoutTime = freezed,}) {
